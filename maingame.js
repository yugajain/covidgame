class Game {
    constructor() {
        ...
        this.jumpSound = loadSound("jump.mp3")
        this.dieSound = loadSound("ooh.mp3")
        this.pingSound = loadSound("ping.mp3")
    }
    play(){
      //  this.bg.x = 400
      //  this.bg.y = 200;
   ...
   this.touch();
      ...
      else if(this.playState === "END"){

       this.ground.velocityX = 0
      // this.obstaclegroup.setLifetimeEach(0);
      // this.maskGroup.setLifetimeEach(0);
